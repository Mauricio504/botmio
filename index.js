...
client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `_🌚En nombre de todos los integrantes de este increíble grupo🪀_ *@${num.split('@')[0]}\* _Te damos la bienvenida a_ *${mdata.subject}* _Espero y sea de su agrado🧘🏻‍♂️, lee la *descripción* para evitar ser expulsado *[DIVIERTE🍃]*_`
				...
				teks = `_👋🏻Adios_ *@${num.split('@')[0]}* _No te extrañaremos, jaja se fue un fantasma_ *[El siguiente en salir será buzoniadoo, ok.no]*`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
